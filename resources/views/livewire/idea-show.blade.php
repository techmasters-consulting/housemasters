                ...
                <button type="submit" class="btn btn-primary" >Upload Slides</button>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            x-data="{ isOpen: false }"
                        >
                            <div class="{{ 'status-'.Str::kebab($idea->status->classes) }} text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">{{ $idea->status->name }}</div>
                            @auth
                            <div class="relative">
                                <button
