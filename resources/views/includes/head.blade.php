...
<!-- Fonts -->
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{secure_asset('assets/favicons/apple-touch-icon.png')}}">
    ...
    <link rel="shortcut icon" href="{{secure_asset('assets/favicons/favicon.ico')}}">
    <!-- Google fonts -->
